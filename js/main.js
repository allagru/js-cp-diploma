...
import { createDateElementHTML } from './createElements.js';
import { createDateElementDataAttributes } from './createElements.js';
            ...
            hallsArr.forEach((hall) => {
                if (hall.hall_open === '1') {
                    ...
                    if (seancesFilmInHallArr.length > 0) {
                        ...
                        movieSeancesHall.innerHTML = `<h3 class="movie-seances__hall-title" data-id=${hall.hall_id
